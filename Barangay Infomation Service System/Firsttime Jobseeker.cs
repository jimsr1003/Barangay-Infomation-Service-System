...
{
    public partial class Firsttime_Jobseeker : Form
    {
        ...
        private void btnY_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.Yes)
            {
               ...
               string.IsNullOrWhiteSpace(tbS.Text) || dtpD.Value == null)
                ...
                string query = "INSERT  INTO FTJS (Fullname, Age, Status, RDate)" +
                                 "VALUES (@fn, @a, @s, @d)";
                ...
                cmd.Parameters.AddWithValue("@d", dtpD.Value);
        ...
        private void Firsttime_Jobseeker_Load(object sender, EventArgs e)
        {
